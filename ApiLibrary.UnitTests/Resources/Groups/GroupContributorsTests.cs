...
{
    [TestClass]
    public class GroupContributorsTests : SoundCloudResourcesTestBase<User>
    {
        [TestMethod]
        public void When_a_Get_is_performed_on_the_resource_via_the_library_then_the_relative_url_is_correct()
        {
            ...
            var expectedPath = string.Format("/groups/{0}/contributors", groupId);

            TestGetEntityList(expectedPath, () => SoundCloud.Groups[groupId].Contributors.Get());
        }
        ...
        public void When_a_Get_is_performed_Async_on_the_resource_via_the_library_then_the_relative_url_is_correct()
        {
            ...
            TestGetEntityList(expectedPath, () => SoundCloud.Groups[groupId].Contributors.GetAsync());
        }
    }
}